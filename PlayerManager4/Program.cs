...
namespace PlayerManager4
{
    ...
    public class Program
    {
        ...
        private static void ListPlayers(IEnumerable<Player> playerList)
        {
            ...
            Console.WriteLine("2. By name (ascending)");
            Console.WriteLine("3. By name (descending)");
            ...
            switch (option)
            {
                case "1":
                    ...
                    break;
                case "2":
                    sortedList.Sort(new CompareByName(true));
                    break;
                case "3":
                    sortedList.Sort(new CompareByName(false));
                    break;
                default:
                    Console.Error.WriteLine("\n>>> Unknown option! <<<\n");
                    return;
